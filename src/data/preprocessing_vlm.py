...
def preprocessing_data(args, model=None, logger=None):
    ...
    if args.input_file:
        ...
        for d in data:
            ...
            decoder_encoding = decoder_tokenizer(d["html"], return_tensors="pt", max_length=args.decoder_max_length, truncation=True, padding="max_length")
            ...
            #     continue
            d["encoding_inputs"] = {"image_path":args.input_file_dir + "/" + d["image_path"], "ocr_tokens": d["ocr_tokens"], "ocr_bboxes": d["ocr_bboxes"]}
